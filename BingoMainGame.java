...
public class MainGame extends JPanel implements MyConstants {
    ...
    private int hearts;  // 💔 Player starts with 3 hearts
    ...
    public MainGame(String playerName, int selectedDifficulty, String selectedBackground) {
        ...
        switch (selectedDifficulty) {
            case 0 -> {hearts = 5; bgSpeed = 1;}  // Easy
            case 1 -> {hearts = 4; bgSpeed = 3;}  // Normal
            case 2 -> {hearts = 3; bgSpeed = 5;}  // Hard
            case 3 -> {hearts = 2; bgSpeed = 8;} // Extreme
            case 4 -> {hearts = 1; bgSpeed = 12;}// Impossible
            default -> {hearts = 3; bgSpeed = 8;} // Default to Normal
        }
       ...
       // ✅ Set initial Unicorn position above the sky
        ...
        Timer alienTimer = new Timer(1, e -> {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < hearts; i++) {
            g.fillOval(FRAMEWIDTH - 150 + (i * 30), 20, 20, 20); // ❤️ Draw heart symbols
        }
    }
